...
export function ContextMenu({
  ...
  ) => MouseEventHandler<HTMLButtonElement> = (onClick) => (e) => {
    onHide();
    onClick(e);
  };
  ...
  return (
    ...
    >
      {Array.isArray(content)
        ? content.map(
            ({ key, className, sx, style, onClick, title, ...otherOptions }) =>
              onClick ? (
                <ContextMenuItem
                  key={key}
                  ...
                  sx={sx}
                  style={
                    { ...styleProperties?.item, ...style } as CSSProperties
                  }
                ...
                <ContextMenuDivider
                  ...
                  sx={sx}
                  style={
                    { ...styleProperties?.divider, ...style } as CSSProperties
                  }
                />
              )
          )
